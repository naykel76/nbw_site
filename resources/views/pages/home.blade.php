<x-gt-app-layout layout="{{ config('naykel.template') }}" hasContainer class="py-5-3-2-2">
        ...
        <div class="container">
            <div class="grid cols-2 ha-t">
                <div>
                    ...
                    <div class="maxw-md lead"> I design and develop Laravel web applications, dabble in server
                        management and am training to become a full stack developer. </div>
                </div>
                <div>
                    <div class="bx warning-light bdr-3 rounded-1 txt-sm">
                        <p><strong class="txt-red">Heads Up!</strong> This website is a mash up of notes from uni, a
                            seemingly endless supply of YouTube tutorials, and a sprinkle of the wild ideas that invade
                            my brain. While I'd love to claim perfection, I can't promise that. So, do yourself a favour
                            and check for yourself.</p>
    ...
    <section class="relative overflow-x-clip py-2 md:py-4">
        ...
        <div class="container">
            ...
            <x-gt-menu filename="nav-programming" class="grid icon-grid" itemClass="btn py-1 secondary flex-col txt-lg"
                withIcons iconClass="h-3 mb-05" />
        </div>
    ...
    <section class="py-2 md:py-4">
        <div class="container">
            ...
            <x-gt-menu menuname="resources" class="grid icon-grid" itemClass="btn flex-col txt-lg"
